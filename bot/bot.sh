...
cd /usr/bin
wget https://raw.githubusercontent.com/robbyhalintar2/mipon/master/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/robbyhalintar2/mipon/master/bot/kyt.zip
unzip kyt.zip
